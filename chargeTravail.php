            ...
            <div class="doc">
                ...
                <div class="container d-flex justify-content-center align-items-center vh-100">                
                    ...
                    <div class="cadre">
                        ...
                        <p><strong>Heures des salariées :</strong> <?= $chargeTravail['employee_hours'] ?> h</p>
                        <ul>
                            <li><strong>Heures des coordinatrices :</strong> <?= $chargeTravail['employee_hours_coordinatrice'] ?> h</li>
                            <li><strong>Heures des agents d'entretien :</strong> <?= $chargeTravail['employee_hours_agent_entretien'] ?> h</li>
                        </ul>
                    </div>
                </div>
            </div>
