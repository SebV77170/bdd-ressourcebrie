...
if(isset($_POST['validate'])){
    ...
    if(!empty($_POST['numerotransac'])){
        ...
        $fin = "\r Montant total = $prixOfThisTicket € \r Moyen de paiement = $moyenDePaiement \r numéro de transaction = $transac \r\r TVA non applicable, article 293B du Code général des impôts. \r\rMerci de votre visite et à bientôt :-)";
        fwrite($fichier, $fin);
        fclose($fichier);
