...
if($activite == 0){
    ...
    $sth1 -> execute(array($date_actuelledmY, $timestamp, $nombre_vente, $poids, $prix_total_journee, $prix_total_journee_espece, $prix_total_journee_cheque, $prix_total_journee_carte));
}else{
