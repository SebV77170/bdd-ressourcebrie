...
if(isset($_POST['validateespece'])):
        ...
        elseif($_GET['modif']==1):
            if(isset($_GET['ra'])):
                if($_GET['ra']=='trueClient'):
                    $insertDataDansTicketCaisse = $db-> prepare('INSERT INTO ticketdecaisse(id_ticket,nom_vendeur, id_vendeur, date_achat_dt, nbr_objet, moyen_paiement, prix_total, lien, reducbene, reducclient, reducgrospanierclient, reducgropanierbene) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)');
                ...
                elseif($_GET['ra']=='trueGrosPanierClientBene'):
                    $insertDataDansTicketCaisse = $db-> prepare('INSERT INTO ticketdecaisse(id_ticket,nom_vendeur, id_vendeur, date_achat_dt, nbr_objet, moyen_paiement, prix_total, lien, reducbene, reducclient, reducgrospanierclient, reducgropanierbene) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)');
